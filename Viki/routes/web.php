...
Route::group(['middleware' => ['web','auth','application.permission']], function () {
	...
	//Route::get('service/report/exportPdf/{month_id}/{year_id}/{workplace_id}/{region_id}/{client_id}/{worker_id}', //'ReportController@exportDetailedPdf')->name('service.report.export');
	//Route::get('service/report/exportPdf/{month_id}/{year_id}/{workplace_id}/{region_id}/{client_id}/{worker_id}', //'ReportController@exportDetailedPdf')->name('service.report.export');
	//Route::get('service/report/exportExcel/{month_id}/{year_id}/{workplace_id}/{region_id}/{client_id}/{worker_id}', //'ReportController@exportDetailedExcel')->name('service.report.exportExcel');
